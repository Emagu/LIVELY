...
(function ($) {
	...
	$.validator.addMethod("phone", function(value,element) {
		var tel = /[0][1-9]{1,3}\-[0-9]{7,9}/g;
		var mobile = /[0][9][0-9]{2}[0-9]{6}/g;
		return this.optional(element) || (tel.test(value) || mobile.test(value));
	}, "請輸入正確的電話號碼");
	// 電話國碼
	$.validator.addMethod("phonecode", function(value,element) {
		var phonecode = /\+[1-9][0-9]{0,2}/g;
...
//	}, "請輸入正確的身分證字號");
	...
	// 台灣身份證字號格式檢查程式
	$.validator.addMethod("ROC_ID", function(value, element, param) {
	...
	$.validator.addMethod("cardid", function(value,element) {
		var cardid = /^([0-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d{1}|6553[0-5])([0-5]\d{4}|6[0-4]\d{3}|65[0-4]\d{2}|655[0-2]\d{1}|6553[0-5])$/;
		return this.optional(element) || cardid.test(value);
	}, "請輸入正確的卡片編號");
	$.validator.addMethod("legal_txt", function(value,element) {
		var text = /[\a-\z\A-\Z0-9\u4E00-\u9FA5\-]/g;
		return this.optional(element) || (text.test(value));
	}, "請勿輸入非法字元");
	$.validator.addMethod("legal_txt_en", function(value,element) {
		var text = /[\w]/g;
		return this.optional(element) || (text.test(value));
	}, "請勿輸入非法字元");
